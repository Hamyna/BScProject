<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogOut.aspx.cs" Inherits="StudentMailer.Default" %>
    ...
    <tr>  
     ...
     <asp:ImageButton ID="LogoButton" runat="server" AlternateText="Logo" EnableViewState="false" 
        ...
        <table class="center_margin" 
             ...
             <tr> 
             <td> 
               <asp:Label ID="Lb_FeedBack" runat="server" Text="You Have Successfully Log-Out of Student Mailer" /> 
             </td>
             </tr>
             <tr> 
             <td> 
             <asp:LinkButton ID="LBtn_LogIn" Text="Student Mailer Homepage" 
                     PostBackUrl="~/Default.aspx" runat="server" />
             </td>
             </tr>
            </table>
           </td>
